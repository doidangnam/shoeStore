...
<head>
        ...
        <link rel="stylesheet" href="{{ asset('frontend/lib/css/preview.css') }}">
        <!-- animate CSS
        ============================================ -->
        <link rel="stylesheet" href="{{ asset('frontend/css/animate.css') }}">
        <!-- magic CSS
        ============================================ -->
        <link rel="stylesheet" href="{{ asset('frontend/css/magic.css') }}">
        <!-- normalize CSS
        ============================================ -->
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <div class="dashboard">
                                ...
                                <div class="cart-menu">
                                    <ul>
                                        <li><a href="#"> <img src="{{ asset('frontend/img/icon-cart.png')}}" alt=""> <span>2</span> </a>
                                            <div class="cart-info">
                                                <ul>
                                                    <li>
                                                        <div class="cart-img">
                                                            <img src="{{ asset('frontend/img/cart/1.png')}}" alt="">
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="cart-img">
                                                            <img src="{{ asset('frontend/img/cart/2.png')}}" alt="">
                                                        </div>
                                                        <div class="cart-details">
                                                            <a href="#">Fusce aliquam</a>
                                                            <p>1 x $777.00</p>
                                    ...
                                    <ul>
                                        ...
                                        <li class="mega-women"><a href="shop.html">Women</a>
                                            <div class="mega-menu women">
                                                ...
                                                <div class="part-2">
                                                    <a href="#">
                                                        <img src="{{ asset('frontend/img/banner/menu-banner.png')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
        ...
        <div class="slider-area home1">
            <div class="bend niceties preview-2">
                <div id="nivoslider" class="slides">
                    <img src="{{ asset('frontend/img/slider/slider-1.jpg')}}" alt="" title="#slider-direction-1"  />
                    <img src="{{ asset('frontend/img/slider/slider-2.jpg')}}" alt="" title="#slider-direction-2"  />
                </div>
                <!-- direction 1 -->
                            ...
                            <div class="product-menu">
                                ...
                                <div class="side-menu">
                                    ...
                                    <ul class="tab-navigation" role="tablist">
                                        ...
                                        <li> <img src="{{ asset('frontend/img/banner/banner-5.jpg')}}" alt=""> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="single-product">
                                                    ...
                                                    <div class="product-img">
                                                        <a href="single-product.html">
                                                            <img src="{{asset('frontend/img/product/20.png')}}" alt="" class="primary-img">
                                                            <img src="{{asset('frontend/img/product/20.png')}}" alt="" class="secondary-img">
                                                        </a>
                                                    </div>
                    ...
                    <div class="feature-product-slider">
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/2.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/1.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/7.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/8.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/3.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/4.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/10.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/9.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/23.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/23.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/23.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/24.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/13.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/14.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/15.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/16.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/17.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/18.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="big-banner">
                            <a href="#">
                                <img src="{{asset('frontend/img/banner/banner-10.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="new-product-slider">
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/1.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/2.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/19.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/20.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                ...
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img src="{{asset('frontend/img/product/21.png')}}" alt="" class="primary-img">
                                        <img src="{{asset('frontend/img/product/22.png')}}" alt="" class="secondary-img">
                                    </a>
                                </div>
                                <div class="product-name">
                                    <a href="single-product.html" title="Fusce aliquam">Fusce aliquam</a>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="footer-contact">
                            <img src="{{asset('frontend/img/logo-white.png')}}" alt="">
                            ...
                            <div class="twitter-feed">
                                <div class="twitter-article">
                                    <div class="twitter-img">
                                        <a href="#">
                                            <img src="{{asset('frontend/img/twitter/twitter-1.png')}}" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="modal-product">
                                <div class="product-images">
                                    <div class="main-image images">
                                        <img alt="" src="{{asset('frontend/img/product/quick-view.jpg')}}">
                                    </div>
                                </div>
        ...
        <!-- jquery
        ============================================ -->
        <script src="{{ asset('frontend/js/vendor/jquery-1.12.1.min.js')}}"></script>
        <!-- bootstrap JS
        ============================================ -->
